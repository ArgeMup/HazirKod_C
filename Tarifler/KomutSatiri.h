...
#define __HazirKod_C_KomutSatiri_H__
	...
	#include "HazirKod_C_Ayarlar.h"
		...
		#define KomutSatiri_Cevap_Ekle(Tampon, Sekil, ...)							Tampon->Sayac += YI_snprintf(Isaretci_Konumlandir(Tampon->Isaretci, Tampon->Sayac, Tip_char, Tip_char), Tampon_BosAlan(Tampon), Sekil, ##__VA_ARGS__)
