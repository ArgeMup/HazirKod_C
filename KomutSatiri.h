...
////////////////////////////////////////////////////////////////////////////////
#define KomutSatiri_Cevap_Ekle(Tampon, Yazi, ...)		Tampon_DoluAlan(Tampon) += snprintf((Tip_char *)Tampon_Isaretci_GecerliKonum(Tampon), Tampon_BosAlan(Tampon), Yazi, ##__VA_ARGS__)
